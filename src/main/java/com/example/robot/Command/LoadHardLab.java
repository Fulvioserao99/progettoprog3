 ...
 * per il labirinto di difficolta' Hard*/
public class LoadHardLab extends LabCommand {
    ...
    public LoadHardLab(String nome, String cognome, String filename){
        super(nome,cognome,filename);
        this.diff  = 3;
    }
    /**
     * Metodo ridefinito dalla classe astratta, che prende in input l'evento
     * trigger e si occupa della costruzione del livello hard, caricando il file
    ...
    public void loadLab(Event event) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("hardLab.fxml"));
