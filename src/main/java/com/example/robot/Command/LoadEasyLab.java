 ...
 * per il labirinto di difficolta' Easy*/
public class LoadEasyLab extends LabCommand {
    ...
    public LoadEasyLab(String nome, String cognome, String filename){
     ...
     * trigger e si occupa della costruzione del livello easy, caricando il file
